...
import { Mail, MapPin, Phone, Clock, Send, ArrowLeft, Linkedin, Globe, CheckCircle2, Languages } from 'lucide-react'
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-6 mb-4 md:mb-0">
              ...
              <Link href="/contact/en" className="text-sm text-gray-400 hover:text-white transition-colors">
                Contact
              </Link>
            </div>
